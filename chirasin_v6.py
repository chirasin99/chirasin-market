...
app = Flask(__name__)
app.secret_key = 'chirasin_premium_spa_v6_final_key_999'

def init_db():
    conn = sqlite3.connect('chirasin_v6_market.db')
    cursor = conn.cursor()
